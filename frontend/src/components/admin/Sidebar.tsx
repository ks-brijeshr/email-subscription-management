...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsSidebarOpen }) => {
  ...
  const openAPITokenModal = () => setShowAPITokenModal(true);
  const closeAPITokenModal = () => setShowAPITokenModal(false);
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-between items-center px-5 pt-5">
          <h2 className="text-xl font-semibold text-blue-600 tracking-wide">Admin Panel</h2>
          <button
        ...
        <nav className="space-y-1 px-5">
          ...
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7a2 2 0 012 2m-2 0H9a2 2 0 010-4h6a2 2 0 012 2v6a2 2 0 01-2 2h-6" />
            </svg>
          ...
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87M16 7a4 4 0 10-8 0 4 4 0 008 0z" />
            </svg>
        ...
        <div className="px-5 pb-6 mt-auto">
          ...
          >
            ...
            <div className="text-right text-gray-800 font-medium">{userName}</div>
          </Link>
