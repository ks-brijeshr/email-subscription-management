      ...
      >
        ...
        <nav className="space-y-2 px-5">
          ...
          <button
            ...
            className="flex items-center space-x-3 p-3 rounded-lg hover:border-l-4 hover:border-cyan-400 hover:bg-gray-800 transition-all text-white"
          >
            <img src="/api-token.svg" alt="API Token" className="w-6 h-6" />
